...
router.delete('/deletecourse/:name', [auth.JWTauth, auth.checkUserType], course_delete);
...
router.put('/updatecourse/:name', [auth.JWTauth, auth.checkUserType], course_update);
